<section class="role">
    <div class="container">
    <br><br><br><br>
        <h1 style="text-align: center; padding-top: 3rem;">Please Choose Access Type</h1>
        <div class="role-container grid">
        <div class="role-card">
        <div class="links-icon"><a href="<?=base_url()?>studLogin" class="links-link"><i class="fa-solid fa-user-graduate"></i></a></div>
        ...
        <div class="links-icon"><a href="<?=base_url()?>adLogin" class="links-link"><i class="fa-solid fa-user-tie"></i></a></div>
